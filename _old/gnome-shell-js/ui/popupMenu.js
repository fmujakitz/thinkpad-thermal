...
import * as Atk from "@gi-types/atk2"
...
export function isPopupMenuItemVisible(child) {
...
export var PopupBaseMenuItem = GObject.registerClass({
  Properties: {
...
export var PopupMenuItem = GObject.registerClass(
...
export var PopupSeparatorMenuItem = GObject.registerClass(
...
export var Switch = GObject.registerClass({
  Properties: {
...
export var PopupSwitchMenuItem = GObject.registerClass({
...
export var PopupImageMenuItem = GObject.registerClass(
...
export var PopupMenuBase = class extends Signals.EventEmitter {
...
export var PopupMenu = class extends PopupMenuBase {
...
export var PopupDummyMenu = class extends Signals.EventEmitter {
...
export var PopupSubMenu = class extends PopupMenuBase {
 ...
 * to the user
 */
export var PopupMenuSection = class extends PopupMenuBase {
  constructor() {
    super()
...
export var PopupSubMenuMenuItem = GObject.registerClass(
 ...
 */
export var PopupMenuManager = class {
