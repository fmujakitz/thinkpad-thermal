...
interface Session {
    ...
    connect_after(sigName: "completed", callback: Session.CompletedSignalCallback): number
    ...
    connect_after(sigName: "request", callback: Session.RequestSignalCallback): number
    emit(sigName: "request", request: string | null, echo_on: boolean, ...args: any[]): void
    connect(sigName: "show-error", callback: Session.ShowErrorSignalCallback): number
    connect_after(sigName: "show-error", callback: Session.ShowErrorSignalCallback): number
    ...
    connect_after(sigName: "show-info", callback: Session.ShowInfoSignalCallback): number
...
interface TextListener extends Gio.Initable {
    ...
    connect(sigName: "tty-attrs-changed", callback: TextListener.TtyAttrsChangedSignalCallback): number
    connect_after(sigName: "tty-attrs-changed", callback: TextListener.TtyAttrsChangedSignalCallback): number
    emit(sigName: "tty-attrs-changed", object: boolean, ...args: any[]): void

    // Class property signals of PolkitAgent-1.0.PolkitAgent.TextListener

    connect(sigName: "notify::delay", callback: (($obj: TextListener, pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::delay", callback: (($obj: TextListener, pspec: GObject.ParamSpec) => void)): number
    emit(sigName: "notify::delay", ...args: any[]): void
    connect(sigName: "notify::use-alternate-buffer", callback: (($obj: TextListener, pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::use-alternate-buffer", callback: (($obj: TextListener, pspec: GObject.ParamSpec) => void)): number
    emit(sigName: "notify::use-alternate-buffer", ...args: any[]): void
    connect(sigName: "notify::use-color", callback: (($obj: TextListener, pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::use-color", callback: (($obj: TextListener, pspec: GObject.ParamSpec) => void)): number
