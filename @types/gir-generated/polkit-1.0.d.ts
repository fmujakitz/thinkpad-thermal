...
function implicit_authorization_from_string(string: string | null): [ /* returnType */ boolean, /* out_implicit_authorization */ ImplicitAuthorization ]
function implicit_authorization_to_string(implicit_authorization: ImplicitAuthorization): string | null
/**
...
interface Authority extends Gio.AsyncInitable, Gio.Initable {
    ...
    connect_after(sigName: "changed", callback: Authority.ChangedSignalCallback): number
