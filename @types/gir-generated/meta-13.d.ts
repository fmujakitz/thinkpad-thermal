 ...
 */
function accelerator_name(accelerator_mods: Clutter.ModifierType, accelerator_key: number): string | null
...
interface Barrier extends Gio.Initable {
    ...
    connect(sigName: "notify::flags", callback: (($obj: Barrier, pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::flags", callback: (($obj: Barrier, pspec: GObject.ParamSpec) => void)): number
...
module Display {
    ...
    interface ShowResizePopupSignalCallback {
        ($obj: Display, object: boolean, p0: Mtk.Rectangle, p1: number, p2: number): boolean
    }
...
interface Display {
    ...
    get_pad_button_label(pad: Clutter.InputDevice, button_number: number): string | null
    get_pad_feature_label(pad: Clutter.InputDevice, feature: PadFeatureType, direction: PadDirection, feature_number: number): string | null
    /**
    ...
    emit(sigName: "show-resize-popup", object: boolean, p0: Mtk.Rectangle, p1: number, p2: number, ...args: any[]): void
...
module LaunchContext {
    ...
    interface ConstructorProperties extends Gio.AppLaunchContext.ConstructorProperties {
...
interface MonitorManager {
    ...
    emit(sigName: "power-save-mode-changed", object: PowerSaveChangeReason, ...args: any[]): void
...
class MultiTexture extends GObject.Object {
     ...
     */
    constructor(format: MultiTextureFormat, planes: Cogl.Texture, n_planes: number) 
    /**
     * Creates a #MetaMultiTexture with the given `format`. Each of the
     * #CoglTexture<!-- -->s represents a plane.
     * @constructor 
...
interface Plugin {
    ...
    vfunc_size_change(actor: WindowActor, which_change: SizeChange, old_frame_rect: Mtk.Rectangle, old_buffer_rect: Mtk.Rectangle): void
...
module SelectionSourceMemory {
    ...
    interface ConstructorProperties extends SelectionSource.ConstructorProperties {
    }
...
module Stage {
    ...
    interface ConstructorProperties extends Atk.ImplementorIface.ConstructorProperties, Clutter.Animatable.ConstructorProperties, Clutter.Container.ConstructorProperties, Clutter.Scriptable.ConstructorProperties, Clutter.Stage.ConstructorProperties {
    }
...
interface WaylandCompositor {
    ...
    connect_after(sigName: "prepare-shutdown", callback: WaylandCompositor.PrepareShutdownSignalCallback): number
    emit(sigName: "prepare-shutdown", ...args: any[]): void
...
interface Window extends Gio.Initable {
     ...
     */
    client_rect_to_frame_rect(client_rect: Mtk.Rectangle): /* frame_rect */ Mtk.Rectangle
    compute_group(): void
     ...
     */
    frame_rect_to_client_rect(frame_rect: Mtk.Rectangle): /* client_rect */ Mtk.Rectangle
    /**
     ...
     */
    get_work_area_for_monitor(which_monitor: number): /* area */ Mtk.Rectangle
    /**
    ...
    connect_after(sigName: "highest-scale-monitor-changed", callback: Window.HighestScaleMonitorChangedSignalCallback): number
...
interface PluginClass {
    ...
    size_change: (plugin: Plugin, actor: WindowActor, which_change: SizeChange, old_frame_rect: Mtk.Rectangle, old_buffer_rect: Mtk.Rectangle) => void
    ...
    show_tile_preview: (plugin: Plugin, window: Window, tile_rect: Mtk.Rectangle, tile_monitor_number: number) => void
    ...
    show_window_menu_for_rect: (plugin: Plugin, window: Window, menu: WindowMenuType, rect: Mtk.Rectangle) => void
...
interface Shadow {
     ...
     * @param bounds 
     */
    get_bounds(window_x: number, window_y: number, window_width: number, window_height: number, bounds: Mtk.Rectangle): void
    /**
